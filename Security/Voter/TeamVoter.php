...
abstract class TeamVoter implements TeamVoterInterface
{
    ...
    public function vote(TokenInterface $token, $object, array $attributes)
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            if(!$this->isTeamMember($attribute, $object, $token)) {
    ...
    protected function isTeamMember($attribute, $subject, TokenInterface $token)
    {
        ...
        return $this->getMember($token)->getTeam()->getId() === $team->getId();
    }
